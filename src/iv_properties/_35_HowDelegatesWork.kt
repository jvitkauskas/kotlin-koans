...
class EffectiveDate<R> : ReadWriteProperty<R, MyDate> {
    ...
    operator override fun getValue(thisRef: R, property: KProperty<*>): MyDate = this.timeInMillis?.toDate() ?: MyDate(0, 0, 0)
    operator override fun setValue(thisRef: R, property: KProperty<*>, value: MyDate) { this.timeInMillis = value.toMillis() }
}
